...
function Login() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const otpResponse = await fetch("https://admin.urbantyohar.com/api/generate-otp", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100">
      <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-6">
        ...
        <h1 className="text-2xl font-bold text-center text-gray-800 mb-4">Login/Signup</h1>
        ...
        <button
          onClick={handleSkip}
          className="w-full mt-4 py-2 bg-gray-300 text-gray-800 font-medium rounded-lg shadow-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-300"
        >
          Skip for Now
        </button>
